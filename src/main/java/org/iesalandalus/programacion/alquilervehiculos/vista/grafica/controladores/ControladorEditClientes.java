...
public class ControladorEditClientes implements Initializable {
    ...
    public void initAtributtes(ObservableList<Cliente> listaClientes, Cliente cliente) {
		...
		// Inicializar lista y cliente

        this.listaClientes = listaClientes;
        this.cliente = cliente;
        
		// Introducir en los campos de texto el valor de los atributos del cliente seleccionado
		...
		// Inhabilitar que se pueda editar el DNI
